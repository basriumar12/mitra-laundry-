...
public abstract class HomeFragmentBinding extends ViewDataBinding {
  ...
  @NonNull
  public final RecyclerView layananKamiRecyclerview;
  ...
  protected HomeFragmentBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ...
      RecyclerView layananKamiRecyclerview, TextView lihatSemuaLaundryTerdekat,
      RecyclerView rvTerlaris, TextView tvChatBelumDibaca, TextView tvNameHome,
      TextView tvPendapatanBersihBaru, TextView tvPesanBaru, TextView tvPesananKomplain,
      TextView tvPesananSelesai, TextView tvUlasanBaru) {
    super(_bindingComponent, _root, _localFieldCount);
    this.ivNotification = ivNotification;
    this.ivSearch = ivSearch;
    this.layananKamiRecyclerview = layananKamiRecyclerview;
