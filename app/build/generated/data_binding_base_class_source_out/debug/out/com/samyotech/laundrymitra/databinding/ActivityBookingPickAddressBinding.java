...
public abstract class ActivityBookingPickAddressBinding extends ViewDataBinding {
  @NonNull
  ...
  protected ActivityBookingPickAddressBinding(Object _bindingComponent, View _root,
      int _localFieldCount, AppCompatImageView add, TextView address, TextView addressOther,
      TextView addressWork, ImageView back, RelativeLayout cardRely, ConstraintLayout constMain,
  ...
  @NonNull
  public static ActivityBookingPickAddressBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_booking_pick_address, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityBookingPickAddressBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityBookingPickAddressBinding>inflateInternal(inflater, R.layout.activity_booking_pick_address, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_booking_pick_address, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityBookingPickAddressBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityBookingPickAddressBinding>inflateInternal(inflater, R.layout.activity_booking_pick_address, null, false, component);
  }

  public static ActivityBookingPickAddressBinding bind(@NonNull View view) {
  ...
  public static ActivityBookingPickAddressBinding bind(@NonNull View view,
      @Nullable Object component) {
    return (ActivityBookingPickAddressBinding)bind(component, view, R.layout.activity_booking_pick_address);
  }
}
