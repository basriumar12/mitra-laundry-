...
public class ActivityServicePenjualanBindingImpl extends ActivityServicePenjualanBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rvLayananItem, 7);
        sViewsWithIds.put(R.id.priceTotal, 8);
        sViewsWithIds.put(R.id.quantityTotal, 9);
        sViewsWithIds.put(R.id.booking_btn, 10);
        sViewsWithIds.put(R.id.rvOtherService, 11);
    }
    // views
    @NonNull
