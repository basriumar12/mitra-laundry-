...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYDETAILPENJUALAN = 12;

  private static final int LAYOUT_ACTIVITYEDITSERVICE = 13;
  ...
  private static final int LAYOUT_ACTIVITYMANAGEPROFILE = 17;

  private static final int LAYOUT_ACTIVITYMANAGEPROFILEREKENING = 18;

  private static final int LAYOUT_ACTIVITYMANAGETARIKREKENING = 19;
  ...
  private static final int LAYOUT_ACTIVITYPREVIEWORDER = 25;

  private static final int LAYOUT_ACTIVITYREGISTER = 26;

  private static final int LAYOUT_ACTIVITYREGISTERMITRA = 27;

  private static final int LAYOUT_ACTIVITYSCHEDULE = 28;

  private static final int LAYOUT_ACTIVITYSEARCH = 29;

  private static final int LAYOUT_ACTIVITYSERVICEACITIVITY = 30;

  private static final int LAYOUT_ACTIVITYSERVICEMENU = 31;

  private static final int LAYOUT_ACTIVITYSERVICEPENJUALAN = 32;

  private static final int LAYOUT_ACTIVITYSHOPACITIVITY = 33;

  private static final int LAYOUT_ACTIVITYSUCCESSPENJUALAN = 34;

  private static final int LAYOUT_ACTIVITYSUKSESREGISTER = 35;

  private static final int LAYOUT_ACTIVITYTICKETS = 36;

  private static final int LAYOUT_ACTIVITYTOPSERVICES = 37;

  private static final int LAYOUT_ACTIVITYUPLOADKTP = 38;

  private static final int LAYOUT_ACTIVITYWELCOMESCREENS = 39;

  private static final int LAYOUT_ADAPTERADDRESS = 40;

  private static final int LAYOUT_ADAPTERALLSERVICES = 41;

  private static final int LAYOUT_ADAPTERBOOKING = 42;

  private static final int LAYOUT_ADAPTERCHAT = 43;

  private static final int LAYOUT_ADAPTERDETAILPENJUALAN = 44;

  private static final int LAYOUT_ADAPTERITEM = 45;

  private static final int LAYOUT_ADAPTERKHUSUS = 46;

  private static final int LAYOUT_ADAPTERLAYANANITEM = 47;

  private static final int LAYOUT_ADAPTERNEAR = 48;

  private static final int LAYOUT_ADAPTERNOTIFICATION = 49;

  private static final int LAYOUT_ADAPTEROFFERS = 50;

  private static final int LAYOUT_ADAPTERPELAYANAN = 51;

  private static final int LAYOUT_ADAPTERPENJUALAN = 52;

  private static final int LAYOUT_ADAPTERPENJUALANLAYANANITEM = 53;

  private static final int LAYOUT_ADAPTERPENTING = 54;

  private static final int LAYOUT_ADAPTERPOPULARLAUNDRIES = 55;

  private static final int LAYOUT_ADAPTERPREVIEW = 56;

  private static final int LAYOUT_ADAPTERSERVICEMENU = 57;

  private static final int LAYOUT_ADAPTERSERVICES = 58;

  private static final int LAYOUT_ADAPTERTICKET = 59;

  private static final int LAYOUT_ADAPTERTOPSERVICES = 60;

  private static final int LAYOUT_ADDADDRESSBOTTOMSHEET = 61;

  private static final int LAYOUT_DAILOGADDTICKET = 62;

  private static final int LAYOUT_DAILOGCANCELORDER = 63;

  private static final int LAYOUT_DAILOGRATING = 64;

  private static final int LAYOUT_DIALOGBUATTIKET = 65;

  private static final int LAYOUT_FRAGMENTABOUT = 66;

  private static final int LAYOUT_FRAGMENTBOOKING = 67;

  private static final int LAYOUT_FRAGMENTDYNAMIC = 68;

  private static final int LAYOUT_FRAGMENTLAYANAN = 69;

  private static final int LAYOUT_FRAGMENTNEARBY = 70;

  private static final int LAYOUT_FRAGMENTOFFERSHOP = 71;

  private static final int LAYOUT_FRAGMENTOFFERS = 72;

  private static final int LAYOUT_FRAGMENTPENJUALAN = 73;

  private static final int LAYOUT_FRAGMENTPROFILE = 74;

  private static final int LAYOUT_FRAGMENTSERVICES = 75;

  private static final int LAYOUT_HOMEFRAGMENT = 76;

  private static final int LAYOUT_SERVICESADAPTER = 77;

  private static final int LAYOUT_SPECIALOFFERS = 78;
