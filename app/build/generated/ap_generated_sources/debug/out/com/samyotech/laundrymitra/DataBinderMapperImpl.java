...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYDETAILPENJUALAN = 10;
  ...
  private static final int LAYOUT_ACTIVITYMANAGEPROFILE = 14;
  ...
  private static final int LAYOUT_ACTIVITYPREVIEWORDER = 18;

  private static final int LAYOUT_ACTIVITYREGISTER = 19;

  private static final int LAYOUT_ACTIVITYREGISTERMITRA = 20;

  private static final int LAYOUT_ACTIVITYSCHEDULE = 21;

  private static final int LAYOUT_ACTIVITYSEARCH = 22;

  private static final int LAYOUT_ACTIVITYSERVICEACITIVITY = 23;

  private static final int LAYOUT_ACTIVITYSERVICEMENU = 24;

  private static final int LAYOUT_ACTIVITYSERVICEPENJUALAN = 25;

  private static final int LAYOUT_ACTIVITYSHOPACITIVITY = 26;

  private static final int LAYOUT_ACTIVITYSUKSESREGISTER = 27;

  private static final int LAYOUT_ACTIVITYTICKETS = 28;

  private static final int LAYOUT_ACTIVITYTOPSERVICES = 29;

  private static final int LAYOUT_ACTIVITYUPLOADKTP = 30;

  private static final int LAYOUT_ACTIVITYWELCOMESCREENS = 31;

  private static final int LAYOUT_ADAPTERADDRESS = 32;

  private static final int LAYOUT_ADAPTERALLSERVICES = 33;

  private static final int LAYOUT_ADAPTERBOOKING = 34;

  private static final int LAYOUT_ADAPTERCHAT = 35;

  private static final int LAYOUT_ADAPTERDETAILPENJUALAN = 36;

  private static final int LAYOUT_ADAPTERITEM = 37;

  private static final int LAYOUT_ADAPTERKHUSUS = 38;

  private static final int LAYOUT_ADAPTERNEAR = 39;

  private static final int LAYOUT_ADAPTERNOTIFICATION = 40;

  private static final int LAYOUT_ADAPTEROFFERS = 41;

  private static final int LAYOUT_ADAPTERPELAYANAN = 42;

  private static final int LAYOUT_ADAPTERPENJUALAN = 43;

  private static final int LAYOUT_ADAPTERPENTING = 44;

  private static final int LAYOUT_ADAPTERPOPULARLAUNDRIES = 45;

  private static final int LAYOUT_ADAPTERPREVIEW = 46;

  private static final int LAYOUT_ADAPTERSERVICEMENU = 47;

  private static final int LAYOUT_ADAPTERSERVICES = 48;

  private static final int LAYOUT_ADAPTERTICKET = 49;

  private static final int LAYOUT_ADAPTERTOPSERVICES = 50;

  private static final int LAYOUT_ADDADDRESSBOTTOMSHEET = 51;

  private static final int LAYOUT_DAILOGADDTICKET = 52;

  private static final int LAYOUT_DAILOGCANCELORDER = 53;

  private static final int LAYOUT_DAILOGRATING = 54;

  private static final int LAYOUT_DIALOGBUATTIKET = 55;

  private static final int LAYOUT_FRAGMENTABOUT = 56;

  private static final int LAYOUT_FRAGMENTBOOKING = 57;

  private static final int LAYOUT_FRAGMENTDYNAMIC = 58;

  private static final int LAYOUT_FRAGMENTLAYANAN = 59;

  private static final int LAYOUT_FRAGMENTNEARBY = 60;

  private static final int LAYOUT_FRAGMENTOFFERSHOP = 61;

  private static final int LAYOUT_FRAGMENTOFFERS = 62;

  private static final int LAYOUT_FRAGMENTPENJUALAN = 63;

  private static final int LAYOUT_FRAGMENTPROFILE = 64;

  private static final int LAYOUT_FRAGMENTSERVICES = 65;

  private static final int LAYOUT_HOMEFRAGMENT = 66;

  private static final int LAYOUT_SERVICESADAPTER = 67;

  private static final int LAYOUT_SPECIALOFFERS = 68;
  ...
  private static class InnerLayoutIdLookup {
    static final HashMap<String, Integer> sKeys = new HashMap<String, Integer>(68);
