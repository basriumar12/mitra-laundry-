...
public class ActivityScheduleBindingImpl extends ActivityScheduleBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ctvTotalPrice, 6);
        sViewsWithIds.put(R.id.ctvAdded, 7);
        sViewsWithIds.put(R.id.ctvNext, 8);
    }
    // views
    @NonNull
    ...
    public ActivityScheduleBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private ActivityScheduleBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
