...
public class FragmentProfileBindingImpl extends FragmentProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_pesan_baru, 6);
        sViewsWithIds.put(R.id.tv_pendapatan_bersih_baru, 7);
        sViewsWithIds.put(R.id.ctvprofile, 8);
        sViewsWithIds.put(R.id.ctvChangePassword, 9);
        sViewsWithIds.put(R.id.ctvnotification, 10);
        sViewsWithIds.put(R.id.ctvChat, 11);
        sViewsWithIds.put(R.id.ctvSupport, 12);
        sViewsWithIds.put(R.id.ctvAbout, 13);
        sViewsWithIds.put(R.id.ctvLogout, 14);
        sViewsWithIds.put(R.id.relayimage, 15);
        sViewsWithIds.put(R.id.ivAvtaimg, 16);
        sViewsWithIds.put(R.id.updatePhoto, 17);
    }
    // views
    @NonNull
