...
public class FragmentProfileBindingImpl extends FragmentProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ctvprofile, 9);
        sViewsWithIds.put(R.id.ctRekening, 10);
        sViewsWithIds.put(R.id.ctvChangePassword, 11);
        sViewsWithIds.put(R.id.ctvnotification, 12);
        sViewsWithIds.put(R.id.ctvChat, 13);
        sViewsWithIds.put(R.id.ctvSupport, 14);
        sViewsWithIds.put(R.id.ctvAbout, 15);
        sViewsWithIds.put(R.id.ctvLogout, 16);
        sViewsWithIds.put(R.id.relayimage, 17);
        sViewsWithIds.put(R.id.ivAvtaimg, 18);
        sViewsWithIds.put(R.id.updatePhoto, 19);
    }
    // views
    @NonNull
