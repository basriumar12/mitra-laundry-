...
public class DetailUlasanActivity extends AppCompatActivity implements View.OnClickListener {

    String TAG = DetailUlasanActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = DetailUlasanActivity.this;
    ...
    private void getUlasan() {
        final ProgressDialog progressDialog = new ProgressDialog(DetailUlasanActivity.this, R.style.CustomAlertDialog);
        ...
        api.getUlasan(userDTO.getShop_id()).enqueue(new Callback<BaseResponse<List<UlasanNewDto>>>() {
            @Override
            public void onResponse(Call<BaseResponse<List<UlasanNewDto>>> call, Response<BaseResponse<List<UlasanNewDto>>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().isStatus()) {
                        ...
                        binding.tvTotalRating.setText(response.body().getTotalRating());
                        binding.tvTotalUlasan.setText(response.body().getData().size());
