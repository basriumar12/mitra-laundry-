...
import com.samyotech.laundrymitra.databinding.ActivityBookingPickAddressBinding;
import com.samyotech.laundrymitra.databinding.ActivityPickupBinding;
...
import com.samyotech.laundrymitra.ui.activity.BookingPickAddressActivity;
...
public class PickupActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void getAddress(double lat, double lng) {
        Geocoder geocoder = new Geocoder(PickupActivity.this, Locale.getDefault());
        try {
        ...
        switch (v.getId()) {
            ...
            case R.id.next_btn:
                ...
                if (binding.rdbtn.isChecked() || binding.rdbtnWork.isChecked() || binding.rdbtnOther.isChecked()) {
                    if (doubleClick) {
                        doubleClick = false;
                        Intent in = new Intent(mContext, DateTimeActivity.class);
