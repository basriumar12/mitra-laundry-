package com.samyotech.laundrymitra.ui.activity.login;
...
import com.samyotech.laundrymitra.databinding.ActivityLoginBinding;
    ...
    public void login() {
        ...
        new HttpsRequest(Consts.LOGIN, getparm(), mContext).stringPost(TAG, new Helper() {
            ...
            public void backResponse(boolean flag, String msg, JSONObject response) {
                ...
                Log.e(TAG, "backResponse: flagd " + " " + flag);
                if (flag) {
                    try {
                        doubleClick = false;
                        ProjectUtils.showToast(mContext, msg);
