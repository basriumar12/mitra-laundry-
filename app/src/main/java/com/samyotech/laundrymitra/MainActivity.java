...
import com.samyotech.laundrymitra.ui.activity.WelcomeScreens;
...
//
//                if (prefference.getIntValue("DAFTAR-") == 1) {
//                    Intent in = new Intent(mContext, UploadKtpActivity.class);
//
//                    startActivity(in);
//                    finish();
//                    overridePendingTransition(R.anim.anim_slide_in_left,
//                            R.anim.anim_slide_out_left);
//                }else  if (prefference.getIntValue("DAFTAR-") == 2) {
